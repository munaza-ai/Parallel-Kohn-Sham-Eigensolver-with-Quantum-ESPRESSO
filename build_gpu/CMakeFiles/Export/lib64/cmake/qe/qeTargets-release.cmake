...
list(APPEND _IMPORT_CHECK_TARGETS qe_fftx )
list(APPEND _IMPORT_CHECK_FILES_FOR_qe_fftx "${_IMPORT_PREFIX}/lib64/libqe_fftx.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS qe_fftx_c )
list(APPEND _IMPORT_CHECK_FILES_FOR_qe_fftx_c "${_IMPORT_PREFIX}/lib64/libqe_fftx_c.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS qe_utilx )
list(APPEND _IMPORT_CHECK_FILES_FOR_qe_utilx "${_IMPORT_PREFIX}/lib64/libqe_utilx.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS qe_utilx_c )
list(APPEND _IMPORT_CHECK_FILES_FOR_qe_utilx_c "${_IMPORT_PREFIX}/lib64/libqe_utilx_c.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS qe_device_lapack )
list(APPEND _IMPORT_CHECK_FILES_FOR_qe_device_lapack "${_IMPORT_PREFIX}/lib64/libqe_device_lapack.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS qe_devmem )
list(APPEND _IMPORT_CHECK_FILES_FOR_qe_devmem "${_IMPORT_PREFIX}/lib64/libqe_devmem.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS qe_lax )
list(APPEND _IMPORT_CHECK_FILES_FOR_qe_lax "${_IMPORT_PREFIX}/lib64/libqe_lax.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS qe_kssolver_davidson )
list(APPEND _IMPORT_CHECK_FILES_FOR_qe_kssolver_davidson "${_IMPORT_PREFIX}/lib64/libqe_kssolver_davidson.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS qe_kssolver_dense )
list(APPEND _IMPORT_CHECK_FILES_FOR_qe_kssolver_dense "${_IMPORT_PREFIX}/lib64/libqe_kssolver_dense.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS cb_lib )
list(APPEND _IMPORT_CHECK_FILES_FOR_cb_lib "${_IMPORT_PREFIX}/lib64/libcb_lib.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS cb_operators )
list(APPEND _IMPORT_CHECK_FILES_FOR_cb_operators "${_IMPORT_PREFIX}/lib64/libcb_operators.a" )
...
list(APPEND _IMPORT_CHECK_TARGETS cb_davidson_main.x )
list(APPEND _IMPORT_CHECK_FILES_FOR_cb_davidson_main.x "${_IMPORT_PREFIX}/bin/cb_davidson_main.x" )
